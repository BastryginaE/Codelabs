...
file = open(r'allres.txt', 'wb')

# Запись в файл

pickle.dump(results.ResG, file)
pickle.dump(results.ResF, file)
pickle.dump(results.ResY, file)
file.close()

# Открытие файла для чтения

file = open(r'allres.txt', 'rb')
results.ResG = pickle.load(file)
results.ResF = pickle.load(file)
results.ResY = pickle.load(file)
